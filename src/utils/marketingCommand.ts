...
export const marketingCommandKeys = [MARKETING_STAFF_KEY, MARKETING_BRIEF_KEY, MARKETING_LAUNCH_REVIEW_KEY, MARKETING_CALENDAR_KEY] as const;
...
export function formatMarketingCommand(snapshot: MarketingCommandSnapshot): string {
  return [
    ...
    'Budget and scorecard pages are temporary worksheets and are not included in this saved-record summary. Review their copied drafts separately.',
