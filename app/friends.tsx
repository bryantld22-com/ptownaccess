...
import { FriendCircle } from '../src/components/FriendCircle';
...
const questions = [
  { question: 'Are these real PTown members?', answer: 'The sample profiles are fictional. Your private friend list contains only the nicknames and ideas you enter on this device; no real PTown accounts or live conversations exist in this preview.' },
...
export default function Friends() {
  ...
  return <Screen>
    ...
    <PreviewNotice />
    <Card title="A private list and a social preview" description="You can build a personal list on this device. The profiles farther below are fictional examples. No account, friend request, in-app message, invitation delivery tracking, or RSVP is created. You can share reviewed invitation text outside the app." />
    <FriendCircle onChooseInvite={setInviteName} />
    {inviteName && <Card title={`Invitation draft for ${inviteName}`} description="The nickname appears only in the draft below. Choose Copy or Share yourself; no invitation has been sent." />}
    <FriendInvitation recipientName={inviteName} />
