...
export default function MediaGroup() {
  return <Screen>
    ...
    <View style={styles.grid}>{mediaGroupDivisions.map(division => <SectionCard key={division.title} title={division.title} subtitle={division.description} href="/media" icon={division.icon} />)}</View>
