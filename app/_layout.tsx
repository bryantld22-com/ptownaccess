...
export default function RootLayout() {
  return <SafeAreaProvider><PreviewStoreProvider><StatusBar style="light" /><Stack screenOptions={{ headerStyle: { backgroundColor: theme.colors.background }, headerTintColor: theme.colors.cream, headerTitleStyle: { fontSize: 16 }, contentStyle: { backgroundColor: theme.colors.background } }}>
    ...
    <Stack.Screen name="farm-to-table" options={{ title: 'PTown Farm To Table' }} />
    <Stack.Screen name="marketing" options={{ title: 'PTown Marketing & Brand' }} />
    <Stack.Screen name="marketing-command" options={{ title: 'Marketing Command Review' }} />
    ...
    <Stack.Screen name="marketing-staff" options={{ title: 'Marketing Proposed Staffing' }} />
    <Stack.Screen name="marketing-staff-backup" options={{ title: 'Marketing Staffing Transfer' }} />
    <Stack.Screen name="marketing-brief" options={{ title: 'Marketing Campaign Brief' }} />
    <Stack.Screen name="marketing-brief-backup" options={{ title: 'Marketing Campaign Brief Transfer' }} />
    ...
    <Stack.Screen name="save-the-arts-leadership" options={{ title: 'Save the Arts Leadership Briefing' }} />
    <Stack.Screen name="sta-mentor-readiness" options={{ title: 'Save the Arts Mentor Readiness' }} />
    <Stack.Screen name="sta-mentor-pilot" options={{ title: 'Save the Arts Mentor Pilot' }} />
    <Stack.Screen name="sta-mentor-session" options={{ title: 'Save the Arts Mentor Session' }} />
    <Stack.Screen name="sta-grant-brief" options={{ title: 'Save the Arts Grant Meeting Brief' }} />
    ...
    <Stack.Screen name="sta-assignment-backup" options={{ title: 'Save the Arts Assignment Transfer' }} />
