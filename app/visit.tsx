...
export default function Visit() {
  ...
  return <Screen>
    ...
    {programs.map(event => event.monthlyFeature && <View key={`monthly-${event.id}`} style={{ gap: 12 }}><Card title={event.monthlyFeature.title} description={event.monthlyFeature.description} /><Button label="Explore the monthly tournament" href="/tournament" secondary /></View>)}
