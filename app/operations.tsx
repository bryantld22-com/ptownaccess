...
export default function OperationsScreen() {
  ...
  return (
    <ScrollView style={styles.screen} contentContainerStyle={styles.content}>
      ...
      <Pressable onPress={() => router.push('/operations/production-readiness')} style={styles.production}><Text style={styles.productionLabel}>PRODUCTION STATUS</Text><Text style={styles.productionValue}>Preview storage · Backend not connected →</Text></Pressable>
      <Pressable onPress={() => router.push('/operations/staff-access')} style={styles.secondaryNav}><Text style={styles.secondaryNavText}>Secure Staff Access →</Text></Pressable>
      <View style={styles.operationsNav}><Pressable onPress={() => router.push('/operations/readiness')} style={styles.crmButton}><Text style={styles.crmButtonText}>Management Alerts →</Text></Pressable><Pressable onPress={() => router.push('/operations/artists')} style={styles.secondaryNav}><Text style={styles.secondaryNavText}>Artist CRM →</Text></Pressable><Pressable onPress={() => router.push('/operations/calendar')} style={styles.secondaryNav}><Text style={styles.secondaryNavText}>Calendar · {bookings.length} →</Text></Pressable><Pressable onPress={() => router.push('/operations/outreach')} style={styles.secondaryNav}><Text style={styles.secondaryNavText}>Outreach · {outreachDrafts.length} →</Text></Pressable><Pressable onPress={() => router.push('/operations/economics')} style={styles.secondaryNav}><Text style={styles.secondaryNavText}>Economics →</Text></Pressable><Pressable onPress={() => router.push('/operations/deal-room')} style={styles.secondaryNav}><Text style={styles.secondaryNavText}>Deal Room →</Text></Pressable><Pressable onPress={() => router.push('/operations/show-day')} style={styles.secondaryNav}><Text style={styles.secondaryNavText}>Show Day →</Text></Pressable><Pressable onPress={() => router.push('/operations/settlement')} style={styles.secondaryNav}><Text style={styles.secondaryNavText}>Settlement →</Text></Pressable><Pressable onPress={() => router.push('/operations/post-show')} style={styles.secondaryNav}><Text style={styles.secondaryNavText}>Post-Show →</Text></Pressable><Pressable onPress={() => router.push('/operations/executive-report')} style={styles.secondaryNav}><Text style={styles.secondaryNavText}>Executive Report →</Text></Pressable></View>
...
const styles = StyleSheet.create({
  ...
  production:{backgroundColor:'#2E2018',borderWidth:1,borderColor:'#A96F45',borderRadius:12,padding:12,gap:4},productionLabel:{color:'#E8B07E',fontSize:9,fontWeight:'900',letterSpacing:1.2},productionValue:{color:theme.colors.cream,fontSize:12,fontWeight:'700'},
