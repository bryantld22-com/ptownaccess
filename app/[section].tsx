...
export default function Section() {
  ...
  return <Screen><PageHeader eyebrow={content.eyebrow} title={content.title} description={content.description} /><PreviewNotice />{content.items.map(item => <Card key={item.title} {...item} />)}{section === 'memberships' && <Button label="Explore VIP Society" href="/vip" secondary />}<Button label="Explore PTown" href="/ptown" secondary /><Footer /></Screen>;
}
