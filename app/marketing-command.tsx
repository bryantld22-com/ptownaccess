...
export default function MarketingCommand() {
  ...
  return <Screen>
    ...
    <PageHeader eyebrow="PTOWN MARKETING & BRAND · BUILD 108" title="See the next Marketing decisions." description="A device-local view of staffing, campaign brief, launch checks, planning date, draft budget, and reported campaign outcomes." />
    <PreviewNotice />
    <Card title="Saved planning records" description="This view reads six saved records on this device. It does not show live staffing, bookings, campaign results, available funds, or publication approval. Campaign figures are unverified. Reload after editing another worksheet." />
    ...
    <Button label="Edit proposed staffing" href="/marketing-staff" secondary /><Button label="Edit campaign brief" href="/marketing-brief" secondary /><Button label="Review launch verification" href="/marketing-launch-review" secondary /><Button label="Open twelve-month calendar" href="/marketing-calendar" secondary /><Button label="Edit planning budget" href="/marketing-budget" secondary /><Button label="Edit draft campaign scorecard" href="/marketing-scorecard" secondary /><Footer />
  </Screen>;
}
